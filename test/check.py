...
def main():
    ...
    url = "http://localhost:8080/nisa/register/20060102"
    ...
    url = "http://localhost:8080/nisa/daily/20060102"
    res = requests.get(url)
    if res.status_code != 200:
    ...
    url = "http://localhost:8080/nisa/daily/19990102"
    res = requests.get(url)
    ...
    url = "http://localhost:8080/nisa/daily/1999-01-01"
    res = requests.get(url)
